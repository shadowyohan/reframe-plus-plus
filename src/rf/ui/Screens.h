...
class Menu {
public:
    enum class Page { Main, Settings, Video, Audio, Disk, Interface, Keybinds, Gallery, AutoClips };
...
private:
    ...
    void PageAutoClips(UiContext&, ImVec2, ImVec2, AppModel&);
