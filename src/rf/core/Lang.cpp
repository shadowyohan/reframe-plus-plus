...
constexpr Phrase kEnglish[] = {
    ...
    {"Формат", "Layout"},
    {"Одна звуковая дорожка со звуками", "One track with everything"},
    {"Отдельные дорожки для", "Separate tracks for"},
    {"системы и микрофона", "system and microphone"},
    {"Вторая дорожка появится только с включённым микрофоном!",
     "The second track only appears with the microphone on!"},
    {"горячие клавиши", "hotkeys"},
